...
import com.disgrace.ddripoff.spells.instance.CenturionGloriousAssault;
import com.disgrace.ddripoff.spells.instance.CenturionRiseShields;
import com.disgrace.ddripoff.spells.instance.CenturionShieldSlam;
import com.disgrace.ddripoff.spells.instance.CenturionSwordSwing;
...
public class Centurion extends Hero {
	...
	public Centurion() {// NOSONAR
		...
		allAbilities.add(new CenturionSwordSwing());
		allAbilities.add(new CenturionGloriousAssault());
		allAbilities.add(new CenturionRiseShields());
		allAbilities.add(new CenturionShieldSlam());
