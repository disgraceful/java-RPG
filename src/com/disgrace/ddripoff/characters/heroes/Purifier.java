...
import com.disgrace.ddripoff.spells.instance.PurifierCleanseTheNight;
import com.disgrace.ddripoff.spells.instance.PurifierCulling;
import com.disgrace.ddripoff.spells.instance.PurifierLightslinger;
import com.disgrace.ddripoff.spells.instance.PurifierSpearOfLight;
...
public class Purifier extends Hero {
	...
	public Purifier() {
		...
		allAbilities.add(new PurifierCleanseTheNight());
		allAbilities.add(new PurifierCulling());
		allAbilities.add(new PurifierLightslinger());
		allAbilities.add(new PurifierSpearOfLight());
	}
}
