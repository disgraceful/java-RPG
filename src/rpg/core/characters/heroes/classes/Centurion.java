...
import rpg.core.spells.instances.CenturionGloriousAssault;
import rpg.core.spells.instances.CenturionRiseShields;
import rpg.core.spells.instances.CenturionShieldSlam;
import rpg.core.spells.instances.CenturionSwordSwing;


public class Centurion extends Hero {

	public Centurion() {// NOSONAR
		name = "Centurion";//TODO get name from name pool
